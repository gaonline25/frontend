...
// //   lexicalToHtml,
// // } from "@/lib/api/medicalSpa/fetchMedicalSpaData";

// // const MedicalSpa = async () => {
...
// //   const banner1Background = getResponsiveImageUrls(
// //     bannerSection1?.backgroundImage
// //   );
// //   const columnMedia = getResponsiveImageUrls(columnSection?.mediaImage);
// //   const banner2Background = getResponsiveImageUrls(
...
// //       case "indexList":
// //         return (
// //           indexListSection?.show &&
// //           indexListSection.items && (
// //             <div
...
// //               <div className="row ">
// //                 <div className="inner">
// //                   {indexListSection.items.map((item: any, idx: number) => (
// //                     <a
// //                       key={idx}
// //                       href={item.url}
// //                       className="item"
...
// //                     <img
// //                       src={
// //                         typeof introSection.logo === "string"
// //                           ? introSection.logo
// //                           : introSection.logo.url
// //                       }
// //                       width={58}
// //                       height={64}
// //                       loading="lazy"
...
// //                       <>
// //                         {" "}
// //                         <span className="small">{introSection.subheading}</span>
// //                       </>
// //                     )}
// //                   </h2>
...
// //                   media="(max-width:420px)"
// //                   srcSet={`data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=`}
// //                   data-lazyload-srcset={`${banner1Background.mobile}, ${banner1Background.mobile} 2x`}
// //                 />
// //                 <source
// //                   media="(max-width:800px)"
// //                   srcSet={`data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=`}
// //                   data-lazyload-srcset={`${banner1Background.tablet}, ${banner1Background.tablet} 2x`}
// //                 />
// //                 <source
// //                   media="(max-width:1400px)"
// //                   srcSet={`data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=`}
// //                   data-lazyload-srcset={`${banner1Background.desktop}, ${banner1Background.desktop} 2x`}
// //                 />
// //                 <source
// //                   srcSet={`data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=`}
// //                   data-lazyload-srcset={banner1Background.large}
// //                 />
// //                 <img
// //                   src={`data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=`}
// //                   data-lazyload-src={banner1Background.large}
// //                   loading="lazy"
// //                   data-lazyload="img"
// //                   width="2200"
// //                   height="802"
// //                   alt={banner1Background.alt}
// //                   draggable="false"
// //                 />
// //               </picture>
// //             </div>
...
// //                       key={idx}
// //                       style={{
// //                         backgroundColor: box.customBackgroundColor || undefined,
// //                         color: box.customTextColor || undefined,
// //                       }}
// //                     >
// //                       <h3>
// //                         {box.linkUrl ? (
// //                           <a href={box.linkUrl}>
// //                             {box.linkText || box.heading}
// //                           </a>
// //                         ) : (
// //                           box.heading
// //                         )}
// //                         {box.linkText && box.linkUrl && `: ${box.heading}`}
// //                       </h3>
// //                       <p>{box.content}</p>
// //                     </div>
// //                   ))}
...
// //               key="column"
// //               style={{
// //                 backgroundColor: columnSection.backgroundColor || undefined,
// //                 color: columnSection.textColor || undefined,
// //               }}
// //             >
// //               <div
// //                 className={`row pt-0 mb-30 media-${
// //                   columnSection.mediaPosition || "right"
// //                 }`}
// //                 data-api-key="content"
// //               >
// //                 <div className="item">
// //                   <h2>
// //                     {columnSection.headingLink ? (
// //                       <a href={columnSection.headingLink}>
...
// //                     media="(max-width:420px)"
// //                     srcSet={`data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=`}
// //                     data-lazyload-srcset={`${columnMedia.mobile}, ${columnMedia.mobile} 2x`}
// //                   />
// //                   <source
// //                     media="(max-width:800px)"
// //                     srcSet={`data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=`}
// //                     data-lazyload-srcset={`${columnMedia.tablet}, ${columnMedia.tablet} 2x`}
// //                   />
// //                   <source
// //                     srcSet={`data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=`}
// //                     data-lazyload-srcset={columnMedia.desktop}
// //                   />
// //                   <img
// //                     src={`data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=`}
// //                     data-lazyload-src={columnMedia.desktop}
// //                     loading="lazy"
// //                     data-lazyload="img"
// //                     width="904"
// //                     height="1062"
...
// //                 <div className="content" data-api-key="top_content">
// //                   <div className="columns-two vertical-align">
// //                     {bannerSection2.headingLink && (
// //                       <a href={bannerSection2.headingLink}></a>
// //                     )}
// //                     <div>
// //                       {bannerSection2.headingLink && (
// //                         <a href={bannerSection2.headingLink}></a>
// //                       )}
// //                       <h2>
// //                         {bannerSection2.subheading && (
// //                           <span className="small">
// //                             {bannerSection2.headingLink ? (
// //                               <a href={bannerSection2.headingLink}>
// //                                 {bannerSection2.subheading}
// //                               </a>
// //                             ) : (
// //                               bannerSection2.subheading
...
// //                       </h2>
// //                     </div>
// //                     <div>{renderRichText(bannerSection2.content)}</div>
// //                   </div>
// //                 </div>
// //               </div>
// //               <picture className="background">
...
// //                   media="(max-width:420px)"
// //                   srcSet={`data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=`}
// //                   data-lazyload-srcset={`${banner2Background.mobile}, ${banner2Background.mobile} 2x`}
// //                 />
// //                 <source
// //                   media="(max-width:800px)"
// //                   srcSet={`data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=`}
// //                   data-lazyload-srcset={`${banner2Background.tablet}, ${banner2Background.tablet} 2x`}
// //                 />
// //                 <source
// //                   media="(max-width:1400px)"
// //                   srcSet={`data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=`}
// //                   data-lazyload-srcset={`${banner2Background.desktop}, ${banner2Background.desktop} 2x`}
// //                 />
// //                 <source
// //                   srcSet={`data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=`}
// //                   data-lazyload-srcset={banner2Background.large}
// //                 />
// //                 <img
// //                   src={`data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=`}
// //                   data-lazyload-src={banner2Background.large}
// //                   loading="lazy"
// //                   data-lazyload="img"
// //                   width="2200"
// //                   height="802"
// //                   alt={banner2Background.alt}
// //                   draggable="false"
// //                 />
// //               </picture>
// //             </div>
...
// //               <div className="row subcontent ">
// //                 <div className="inner">
// //                   {pageIndexSection.cards.map((card: any, idx: number) => {
...
// //                               <source
// //                                 srcSet={`data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=`}
// //                                 data-lazyload-srcset={cardImage.desktop}
// //                               />
// //                               <img
// //                                 src={`data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=`}
// //                                 data-lazyload-src={cardImage.desktop}
// //                                 loading="lazy"
// //                                 data-lazyload="img"
// //                                 width="850"
// //                                 height="534"
...
// //                                   pageIndexSection.cardTextColor ||
// //                                   undefined,
// //                               }}
// //                             >
// //                               <span>{card.labelText || card.title}</span>
// //                             </div>
// //                           </div>
// //                         </a>
// //                         <div className="copy">
...
//                   <h2>
//                     {columnSection.headingLink ? (
//                       <Link href={columnSection.headingLink}>
//                         {columnSection.heading}
//                       </Link>
//                     ) : (
//                       columnSection.heading
...
//                   <div className="columns-two vertical-align">
//                     {bannerSection2.headingLink && (
//                       <Link href={bannerSection2.headingLink}></Link>
//                     )}
//                     <div>
//                       {bannerSection2.headingLink && (
//                         <Link href={bannerSection2.headingLink}></Link>
...
//                           <span className="small">
//                             {bannerSection2.headingLink ? (
//                               <Link href={bannerSection2.headingLink}>
//                                 {bannerSection2.subheading}
//                               </Link>
//                             ) : (
//                               bannerSection2.subheading
...
interface MedicalSpaProps {
  data: any;
}

const MedicalSpa: React.FC<MedicalSpaProps> = ({ data }) => {
  if (!data) {
    return <div>Loading...</div>;
  }
