...
import { getResponsiveImageUrls } from "@/lib/api/medicalSpa/fetchSpaServicesPageComponent";
...
interface SpaServicesProps {
  data: SpaServicesData | null;
}

const SpaServices: React.FC<SpaServicesProps> = ({ data: pageData }) => {
  useEffect(() => {
