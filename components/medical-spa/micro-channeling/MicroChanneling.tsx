...
interface MicroChannelingPageProps {
  data: MicroChannelingData | null;
}
...
export function getResponsiveImageUrls(imageGroup: any) {
  ...
  return {
    ...
    large: getImageUrl(imageGroup.large),
    alt: imageGroup.alt || "",
    width: imageGroup.width || 0,
    height: imageGroup.height || 0,
  };
}
...
const MicroChanneling: React.FC<MicroChannelingPageProps> = ({ data }) => {
  if (!data) {
    return (
  ...
  const heroImages = heroSection.show
  ...
  const heroMediaImages = heroSection.show
    ...
    : {};
  const introLogo = introSection.logo;
  const banner1Images = bannerSection1.show
    ? getResponsiveImageUrls(bannerSection1.backgroundImage)
    : {};
  const columnMedia1Images = columnMediaSection1.show
    ? getResponsiveImageUrls(columnMediaSection1.image)
    : {};
  const halfImage1Images = halfImageSection1.show
    ? getResponsiveImageUrls(halfImageSection1.image)
    : {};
  const banner2Images = bannerSection2.show
    ? getResponsiveImageUrls(bannerSection2.backgroundImage)
    : {};
  const columnMedia2Images = columnMediaSection2.show
    ? getResponsiveImageUrls(columnMediaSection2.image)
    : {};
  ...
  return (
    <main id="main">
      ...
      {introSection.show && (
        <div
          className={`mod_intro container viewport ${introSection.layout || "option-1"} ${introSection.containerWidth || "wide"} wow ${introSection.animationType || "fadeInUp"}`}
          data-s3-module
        >
          <div className="row">
            {introLogo && (
      ...
      {bannerSection1.show && (
        <div
          className={`mod_banner ${bannerSection1.theme || "dark"} ${bannerSection1.hideDivider ? "hide-divider" : ""} viewport ${bannerSection1.backgroundStyle || "background-6"}`}
          data-s3-module
        >
          <div
            className={`row wow ${bannerSection1.animationType || "fadeInUp"}`}
          >
            <div className="content" data-api-key="top_content">
              <h2
                className={
              ...
              <div className={bannerSection1.columnLayout || "columns-two"}>
      ...
      {columnSection1.show && (
        <div className="mod_column viewport container" data-s3-module>
          <div
            className={`row ${columnSection1.marginTop || "mt-30"} ${columnSection1.marginBottom || "mb-30"}`}
            data-api-key="content"
          >
            <div className="item">
              <h2 className={columnSection1.headingAlignment || "text-center"}>
                {columnSection1.heading}
              </h2>
              <div className={columnSection1.columnLayout || "columns-two"}>
      ...
      {/* CTA General Module */}
      {ctaGeneralSection1.show && (
        <div
          className={`mod_cta_general viewport container cta ${ctaGeneralSection1.containerWidth || "thin"} wow ${ctaGeneralSection1.animationType || "fadeInRight"} ${ctaGeneralSection1.marginTop || "mt-0"} ${ctaGeneralSection1.marginBottom || "mb-0"} ${ctaGeneralSection1.backgroundStyle || "background-2"}`}
          data-s3-module
        >
          <div className="row">
            <div className="text">
              <h2>
                <a href={ctaGeneralSection1.headingUrl}>
                  {ctaGeneralSection1.heading}
                </a>
              </h2>
              {ctaGeneralSection1.ctaButton.show && (
                <a
                  href={ctaGeneralSection1.ctaButton.url}
                  className={`btn ${ctaGeneralSection1.ctaButton.style || "white"}`}
                >
      ...
      {columnMediaSection1.show && (
        <div className="mod_column viewport container has-media" data-s3-module>
          <div
            className={`row ${columnMediaSection1.marginTop || "mt-30"} ${columnMediaSection1.marginBottom || "mb-30"} ${columnMediaSection1.imagePosition || "media-right"}`}
            data-api-key="content"
          >
            <div className="item">
      ...
      {halfImageSection1.show && (
        <div
          className={`mod_half_image viewport half-image container wow ${halfImageSection1.animationType || "fadeInLeft"} ${halfImageSection1.backgroundStyle || "background-navy"}`}
          data-s3-module
        >
          <div
            className={`row half-image-row ${halfImageSection1.marginTop || "mt-0"} ${halfImageSection1.marginBottom || "mb-0"}`}
          >
            <div className="media">
              <picture className="background">
                <source
            ...
            <div
              className={`copy ${halfImageSection1.contentPadding || "padded"}`}
            >
              <div className="inner">
                <div className="content" data-api-key="content">
                  ...
                  />
                  {halfImageSection1.listItems &&
                    halfImageSection1.listItems.length > 0 && (
                      <ul
                        className={
                          halfImageSection1.listStyle === "columns"
                            ? "columns"
                            : ""
                        }
                      >
                        {halfImageSection1.listItems.map((item, index) => (
                          <li key={index}>{item.item}</li>
                        ))}
                      </ul>
                    )}
      ...
      {columnSection2.show && (
        <div className="mod_column viewport container" data-s3-module>
          <div
            className={`row ${columnSection2.marginTop || "mt-30"} ${columnSection2.marginBottom || "mb-30"}`}
            data-api-key="content"
          >
            <div className="item">
      ...
      {bannerSection2.show && (
        <div
          className={`mod_banner ${bannerSection2.theme || "dark"} ${bannerSection2.hideDivider ? "hide-divider" : ""} viewport ${bannerSection2.backgroundStyle || "background-8"}`}
          data-s3-module
        >
          <div
            className={`row wow ${bannerSection2.animationType || "fadeInUp"}`}
          >
            <div className="content" data-api-key="top_content">
              <h2
                className={
              ...
              <div className={bannerSection2.columnLayout || "columns-three"}>
      ...
      {columnMediaSection2.show && (
        <div className="mod_column viewport container has-media" data-s3-module>
          <div
            className={`row ${columnMediaSection2.marginTop || "mt-30"} ${columnMediaSection2.imagePosition || "media-left"}`}
            data-api-key="content"
          >
            <div className="item">
