...
const LinesAndWrinklesPage: React.FC<{ data: any }> = ({ data }) => {
  const sliderRef = useRef<HTMLDivElement>(null);
  const [currentSlide, setCurrentSlide] = useState(0);

  useEffect(() => {
    if (!data?.beforeAfterSection?.patients?.length || !sliderRef.current)
      return;

    const slider = sliderRef.current;
    const totalSlides = data.beforeAfterSection.patients.length;
    const autoPlayInterval = 5000;
    ...
    return () => clearInterval(intervalId);
  }, [data?.beforeAfterSection?.patients?.length]);

  useEffect(() => {
    if (!sliderRef.current || !data?.beforeAfterSection?.patients?.length)
      return;
  ...
  }, [currentSlide, data?.beforeAfterSection?.patients?.length]);
    ...
    <main id="main">
            ...
            <div className="row">
              <div className="inner">
                {data.heroSection?.breadcrumbs?.length > 0 && (
                  <ul className="partial_breadcrumb" data-s3-partial>
                    {data.heroSection.breadcrumbs.map(
                      (breadcrumb: any, index: number) => (
                        <li key={index}>
                          <a
                            href={breadcrumb.url}
        ...
        >
          <div className="row pb-0">
            {data.introSection?.logo && (
              <picture className="logo">
                <img
                  src={getImageUrl(data.introSection.logo)}
                  width={58}
                  height={64}
                  loading="lazy"
                  alt={data.introSection?.logoAlt}
                  draggable="false"
                  data-api-key="logo"
                />
              </picture>
            ...
            <div className="inner" data-api-key="content">
              {data.introSection?.heading && (
                <h2>{data.introSection.heading}</h2>
              )}
              ...
              <div className="inner">
                <div className="content" data-api-key="content">
                  {data.halfImageSection1?.heading && (
                    <h2>{data.halfImageSection1.heading}</h2>
                  )}
      ...
      {data.beforeAfterSection?.show && (
        ...
        >
          <div className="row">
            <div className="text">
              {data.beforeAfterSection?.heading && (
                <h2 data-api-key="title">{data.beforeAfterSection.heading}</h2>
              )}
              <div className="patients" data-api-key="patients">
                <div
                  className="patient-wrap pslider"
                  ...
                  // }}
                >
                  {data.beforeAfterSection?.patients?.map(
                    (patient: any, index: number) => {
                      const images = getResponsiveImageUrls(patient.image);
                      return (
                        <div
              ...
              {data.beforeAfterSection?.galleryButton?.show && (
                <a
                  href={data.beforeAfterSection.galleryButton.url}
                  className="btn view-more"
                  title="View before and after gallery images"
                  aria-label="View before and after gallery images"
                >
                  {data.beforeAfterSection.galleryButton.text}
                </a>
              )}
            </div>
          </div>
      ...
      {data.bannerSection1?.show && (
        ...
        >
          <div className="row wow fadeInUp">
            <div className="content" data-api-key="top_content">
              {data.bannerSection1?.heading && (
                <h2 className="text-center">
                  {data.bannerSection1.subheading && (
                    <span className="small">
                      {data.bannerSection1.subheading}
                    </span>
                  )}
              ...
              {data.bannerSection1?.content && (
                <div
                  dangerouslySetInnerHTML={{
                    __html: lexicalToHtml(data.bannerSection1.content),
                  }}
                />
              )}
              {data.bannerSection1?.bulletPoints?.length > 0 && (
                <ul className="columns">
                  {data.bannerSection1.bulletPoints.map(
                    (bullet: any, index: number) => (
                      <li
                        key={index}
                        dangerouslySetInnerHTML={{
              ...
              {data.bannerSection1?.closingContent && (
                <div
                  dangerouslySetInnerHTML={{
                    __html: lexicalToHtml(data.bannerSection1.closingContent),
                  }}
                />
              )}
            </div>
          ...
          <picture className="background">
            {(() => {
              const images = getResponsiveImageUrls(
                data.bannerSection1.backgroundImage
              );
              return (
                <>
                  <source
      ...
      {data.boxGridSection1?.show && (
        ...
        >
          <div className="row">
            {(data.boxGridSection1?.headingBefore ||
              data.boxGridSection1?.contentBefore) && (
              <div className="content-before">
                {data.boxGridSection1?.headingBefore && (
                  <h2>{data.boxGridSection1.headingBefore}</h2>
                )}
                {data.boxGridSection1?.contentBefore && (
                  <div
                    dangerouslySetInnerHTML={{
                      __html: lexicalToHtml(data.boxGridSection1.contentBefore),
                    }}
                  />
                )}
              </div>
            ...
            <div className="boxes">
              {data.boxGridSection1?.boxes?.map((box: any, index: number) => (
                <div className="box wow fadeInUp" key={index}>
                  {box.heading && <h3>{box.heading}</h3>}
                  {box.content && (
                    <div
      ...
      {data.bannerSection2?.show && (
        ...
        >
          <div className="row wow fadeInUp">
            <div className="content" data-api-key="top_content">
              {data.bannerSection2?.heading && (
                <h2 className="text-center">{data.bannerSection2.heading}</h2>
              )}
              {data.bannerSection2?.content && (
                <div
                  className="text-center"
                  dangerouslySetInnerHTML={{
                    __html: lexicalToHtml(data.bannerSection2.content),
                  }}
                />
              )}
              {data.bannerSection2?.bulletPoints?.length > 0 && (
                <ul className="columns">
                  {data.bannerSection2.bulletPoints.map(
                    (bullet: any, index: number) => (
                      <li
                        key={index}
                        dangerouslySetInnerHTML={{
          ...
          <picture className="background">
            {(() => {
              const images = getResponsiveImageUrls(
                data.bannerSection2.backgroundImage
              );
              return (
                <>
                  <source
      ...
      {data.boxGridSection2?.show && (
        ...
        >
          <div className="row">
            {data.boxGridSection2?.headingBefore && (
              <div className="content-before">
                <h2>{data.boxGridSection2.headingBefore}</h2>
              </div>
            )}
            <div className="boxes wider">
              {data.boxGridSection2?.boxes?.map((box: any, index: number) => (
                <div className="box wow fadeInUp" key={index}>
                  {box.heading && <h3>{box.heading}</h3>}
                  {box.content && (
                    <div
      ...
      {data.columnSection?.show && (
        <div className="mod_column viewport container has-media" data-s3-module>
          <div className="row pt-0 media-right" data-api-key="content">
            <div className="item">
              {data.columnSection?.heading && (
                <h2>{data.columnSection.heading}</h2>
              )}
              {data.columnSection?.content && (
                <div
                  dangerouslySetInnerHTML={{
                    __html: lexicalToHtml(data.columnSection.content),
                  }}
                />
              )}
            </div>
...
export default LinesAndWrinklesPage;