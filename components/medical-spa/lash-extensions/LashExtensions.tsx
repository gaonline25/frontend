...
import {
  ...
  getResponsiveImageUrls,
  lexicalToHtml,
} from "@/lib/api/medicalSpa/fetchLashExtensionsPageComponent";
...
const LashExtensions: React.FC = () => {
  ...
  const heroMediaImages = heroSection.show
    ...
    : {};
  const bannerImages = bannerSection1.show
          ...
          <div className="wrapper">
            ...
            <div className="media">
              <picture className="background">
                ...
                <img
                  src={heroMediaImages.large}
                  alt={heroMediaImages.alt || "Womans eyelashes being brushed"}
                  draggable="false"
                />
              </picture>
            </div>
      ...
      {bannerSection1.show && (
        ...
        >
          <div className="row wow fadeInUp">
            <div className="content" data-api-key="top_content">
              <h2
                className={`text-${bannerSection1.headingAlignment || "center"}`}
              >
                {bannerSection1.heading}
              </h2>
              <div
          ...
          <picture className="background">
            <source media="(max-width:420px)" srcSet={bannerImages.mobile} />
            <source media="(max-width:800px)" srcSet={bannerImages.tablet} />
            <source media="(max-width:1400px)" srcSet={bannerImages.desktop} />
            <source srcSet={bannerImages.large} />
            <img
              src={bannerImages.large}
              loading="lazy"
            ...
            <div className="media">
              <picture className="background">
                ...
                <img
                  src={halfImages.large}
                  loading="lazy"
                  alt={halfImages.alt || "Woman with long eyelashes"}
                  draggable="false"
                  data-api-key="image"
                />
              </picture>
        ...
        >
          <div className="row">
            <div className="text">
              ...
              <a href={ctaGeneralSection.ctaButton.url} className="btn white">
                {ctaGeneralSection.ctaButton.text}
              </a>
            </div>
            <div className="media"></div>
