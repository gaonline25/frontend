...
interface DermalFillersPageProps {
  data: any;
}

const DermalFillersPage: React.FC<DermalFillersPageProps> = ({ data }) => {
  if (!data) {
    return <div className="text-center p-4">No data available</div>;
  }
  ...
  const renderSection = (sectionKey: string) => {
    switch (sectionKey) {
      ...
      case "columnSection1":
        ...
        return (
          <div
            className={`mod_column viewport container ${columnSection1.customClasses || ""}`}
            data-s3-module
            key="columnSection1"
            style={{
              backgroundColor: columnSection1.backgroundColor || undefined,
      ...
      case "halfImageSection":
        ...
        return (
          ...
          >
            <div
              className={`row half-image-row ${!halfImgLeft ? "flipped" : ""} ${vertAlign}-aligned`}
            >
              <div className="media">
                <picture className="background">
                  <source
      ...
      case "columnSection2":
        ...
        return (
          <div
            className={`mod_column viewport container ${columnSection2.customClasses || ""}`}
            data-s3-module
            key="columnSection2"
            style={{
              backgroundColor: columnSection2.backgroundColor || undefined,
