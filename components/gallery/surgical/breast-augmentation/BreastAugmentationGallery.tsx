...
// const BreastAugmentationGallery: React.FC = () => {
...
interface BreastAugmentationGalleryProps {
  data: TummyTuckGalleryPageData | null;
}

const BreastAugmentationGallery: React.FC<BreastAugmentationGalleryProps> = ({
  data,
}) => {
  const [isCarouselOpen, setIsCarouselOpen] = useState(false);
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
