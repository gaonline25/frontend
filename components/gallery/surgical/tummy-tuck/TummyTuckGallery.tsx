...
//           }/tummyTuckPage?where[isActive][equals]=true&depth=2&limit=100&draft=false&trash=false`,
//           {
//             next: { revalidate: 60 },
//             cache: "force-cache",
//           }
...
interface TummyTuckGalleryProps {
  data: TummyTuckGalleryPageData | null;
}

const TummyTuckGallery: React.FC<TummyTuckGalleryProps> = ({ data }) => {
  const [isCarouselOpen, setIsCarouselOpen] = useState(false);
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
