...
// const BreastLiftGallery: React.FC = () => {
...
//           }/BreastLiftGallery?where[isActive][equals]=true&depth=2&limit=100&draft=false&trash=false`,
//           {
//             next: { revalidate: 60 },
//             cache: "force-cache",
//           }
...
interface BreastLiftGalleryProps {
  data: TummyTuckGalleryPageData | null;
}

const BreastLiftGallery: React.FC<BreastLiftGalleryProps> = ({ data }) => {
  const [isCarouselOpen, setIsCarouselOpen] = useState(false);
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
