...
// //           }/MicroChannelingGallery?where[isActive][equals]=true&depth=2&limit=100&draft=false&trash=false`,
// //           {
// //             next: { revalidate: 60 },
// //             cache: "force-cache",
// //           }
...
//             process.env.NEXT_PUBLIC_PAYLOAD_API_URL ||
//             "https://goldfingerbackend.vercel.app/api"
//           }/MicroChannelingGallery?where[isActive][equals]=true&depth=3&limit=1`,
//           {
//             next: { revalidate: 60 },
//             cache: "force-cache",
//           }
...
interface MicroChannelingGalleryProps {
  data: BotoxGalleryPageData | null;
}

const MicroChannelingGallery: React.FC<MicroChannelingGalleryProps> = ({
  data,
}) => {
  const [isCarouselOpen, setIsCarouselOpen] = useState(false);
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
