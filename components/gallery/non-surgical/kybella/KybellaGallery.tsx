    ...
    <main id="main">
      ...
      <div className="container partial_gallery_item_index" data-s3-partial="">
        <div className="row">
          ...
          >
            <a
              href="/gallery/non-surgical/kybella/item/174894582/"
              className="item single"
            >
              <picture className="">
                <source
                  srcSet="https://www.datocms-assets.com/105497/1693336719-content-img2-2.webp?auto=format,compress&w=400"
                  data-lazyload-srcset="https://www.datocms-assets.com/105497/1693336719-content-img2-2.webp?auto=format,compress&w=400"
                />
                <img
                  src="https://www.datocms-assets.com/105497/1693336719-content-img2-2.webp?auto=format,compress&w=400"
                  width="400"
                  height="266"
                  alt="KYBELLA Before & After Gallery - Patient 174894582 - Image 1"
                  draggable="false"
                />
              </picture>
            </a>
            <a
              href="/gallery/non-surgical/kybella/item/168495247/"
              className="item single"
            >
              <picture className="">
                <source
                  srcSet="https://www.datocms-assets.com/105497/1693336601-content-img3-1.jpeg?auto=format,compress&w=400"
                  data-lazyload-srcset="https://www.datocms-assets.com/105497/1693336601-content-img3-1.jpeg?auto=format,compress&w=400"
                />
                <img
                  src="https://www.datocms-assets.com/105497/1693336601-content-img3-1.jpeg?auto=format,compress&w=400"
                  width="400"
                  height="257"
                  alt="KYBELLA Before & After Gallery - Patient 168495247 - Image 1"
                  draggable="false"
                />
              </picture>
            </a>
