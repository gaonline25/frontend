...
interface BodyScriptsProps {
  ...
  googleAdsId?: string;
  iconNodeId?: string;
  birdeyeWidgetId?: string;
}

export default function BodyScripts({
  gtmId = "GTM-5QDJXBX",
  appJsUrl = "/assets/app.min.js",
  captchaJsUrl = "/assets/treCaptcha.min.js",
  gaId = "G-0ZWSKYX3K7",
  googleAdsId = "AW-997436413",
  iconNodeId = "115546",
  birdeyeWidgetId = "1674679674",
}: BodyScriptsProps) {
  return (
    <>
      <Script
      ...
      <Script
        src={`https://birdeye.com/embed/v6/162269425060558/1/${birdeyeWidgetId}/e9adc9bfabcfaed0a1b20e44eee606868b0ab7e184d4ae10`}
        strategy="lazyOnload"
        defer
      />
      ...
      <div id={`bf-revz-widget-${birdeyeWidgetId}`}></div>
    </>
  );
}