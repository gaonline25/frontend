...
import React from "react";
import { getResponsiveImageUrls } from "@/lib/api/plasticSurgery/fetchPlasticSurgeryBodyComponent";
...
interface PlasticSurgeryBodyProps {
  data: PlasticSurgeryBodyData | null;
}

const PlasticSurgeryBody: React.FC<PlasticSurgeryBodyProps> = ({ data }) => {
  if (!data) {
