...
// import SatelliteLocations from "@/components/location/SatelliteLocations";
// import { fetchSatelliteLocationsPageComponent } from "@/lib/api/locations/fetchSatelliteLocationsPageComponent";
// import type { Metadata } from "next";

// export const revalidate = 60; // ✅ ISR: Regenerate static page every 60s

// // ✅ Fetch data from Payload CMS (Server-side)
// async function getData() {
//   try {
//     const data = await fetchSatelliteLocationsPageComponent();
//     return data || null;
//   } catch (error) {
//     console.error("❌ Error fetching Satellite Locations data:", error);
//     return null;
...
//     title:
//       seo.metaTitle ||
//       "Goldfingers Aesthetics | Satellite Locations in Florida",
//     description:
//       seo.metaDescription ||
//       "Find Goldfingers Aesthetics satellite locations near you across Florida. Explore our med spa branches for Botox, fillers, and rejuvenating treatments.",
//     openGraph: {
//       title:
//         seo.metaTitle ||
//         "Goldfingers Aesthetics | Satellite Med Spa Locations in Florida",
//       description:
//         seo.metaDescription ||
//         "Explore all Goldfingers Aesthetics locations across Florida — including Winter Park, Lake Mary, and Winter Garden — offering premium med spa treatments.",
//       images: [
//         {
//           url:
//             seo.ogImage?.url ||
...
//           width: 1200,
//           height: 630,
//           alt: "Goldfingers Aesthetics Satellite Locations",
//         },
//       ],
//     },
//     keywords:
//       seo.keywords ||
//       "Goldfingers Aesthetics, Florida med spa, Botox near me, fillers near me, med spa Florida, Goldfingers locations, aesthetic clinics Florida",
...
// // ✅ Page Entry
// export default async function SatelliteLocationsPage() {
//   const data = await getData();
...
//           Unable to load Satellite Locations content.
//         </p>
//       </main>
//     );
//   }

//   // ✅ Pass CMS data to the client-side component
//   return <SatelliteLocations data={data} />;
// }
...
export async function generateMetadata(): Promise<Metadata> {
  const data = await getData();
  const seo = (data as any)?.seoSettings || {};
  const url = "https://www.goldfingersaesthetics.com/satellite-locations";
  ...
  return {
    ...
    title:
      seo.metaTitle ||
      "Goldfingers Aesthetics Locations Across Florida | Find a Med Spa Near You",

    description:
      seo.metaDescription ||
      "Discover all Goldfingers Aesthetics locations across Florida. Find expert Botox, dermal fillers, and rejuvenating med spa treatments near you.",
    ...
    openGraph: {
      title:
        seo.metaTitle ||
        "Goldfingers Aesthetics | Med Spa Locations Across Florida",
      description:
        seo.metaDescription ||
        "Explore our Florida-wide network of aesthetic clinics offering Botox, fillers, facial rejuvenation, and advanced med spa services.",
      url,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Goldfingers Aesthetics Florida Locations",
        },
      ],
    },
    ...
    keywords: [
      "Goldfingers Aesthetics locations",
      "Florida med spa locations",
      "Botox near me Florida",
      "Dermal fillers Florida",
      "Medical spa near me",
      "Aesthetic clinics Florida",
      "Goldfingers satellite locations",
      "Cosmetic injections Florida",
    ],
  };
}

// ==========================
// ✅ Structured Data (Authority Boost)
// ==========================
const structuredData = {
  ...
  "@graph": [
    ...
    {
      "@type": "WebPage",
      name: "Goldfingers Aesthetics Satellite Locations",
      url: "https://www.goldfingersaesthetics.com/satellite-locations",
      isPartOf: {
        "@type": "WebSite",
        name: "Goldfingers Aesthetics",
        url: "https://www.goldfingersaesthetics.com",
    ...
    {
      "@type": "ItemList",
      name: "Goldfingers Aesthetics Florida Locations",
      itemListElement: [
        { "@type": "ListItem", position: 1, name: "Clearwater" },
        { "@type": "ListItem", position: 2, name: "Clermont" },
        { "@type": "ListItem", position: 3, name: "Daytona Beach" },
        { "@type": "ListItem", position: 4, name: "Downtown Orlando" },
        { "@type": "ListItem", position: 5, name: "Downtown Tampa" },
        { "@type": "ListItem", position: 6, name: "Longwood" },
        { "@type": "ListItem", position: 7, name: "Mount Dora" },
        { "@type": "ListItem", position: 8, name: "New Smyrna Beach" },
        { "@type": "ListItem", position: 9, name: "Ocala" },
        { "@type": "ListItem", position: 10, name: "Orlando" },
        { "@type": "ListItem", position: 11, name: "Port Orange" },
        { "@type": "ListItem", position: 12, name: "Sarasota" },
        { "@type": "ListItem", position: 13, name: "St. Petersburg" },
        { "@type": "ListItem", position: 14, name: "Tampa" },
        { "@type": "ListItem", position: 15, name: "Wesley Chapel" },
        { "@type": "ListItem", position: 16, name: "Winter Garden" },
        { "@type": "ListItem", position: 17, name: "Winter Park" },
        { "@type": "ListItem", position: 18, name: "The Villages" },
      ],
    },
  ],
};
...
export default async function SatelliteLocationsPage() {
  ...
  return (
    <>
      <Script
        id="satellite-locations-structured-data"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(structuredData),
        }}
      />
      <SatelliteLocations data={data} />
    </>
  );
}
