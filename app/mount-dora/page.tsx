...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    title:
      seo.metaTitle ||
      "Botox & Dermal Fillers in Mount Dora, FL | Goldfingers Aesthetics",

    description:
      seo.metaDescription ||
      "Looking for Botox in Mount Dora, FL? Goldfingers Aesthetics provides expert dermal fillers, lip injections, and advanced aesthetic treatments in Mount Dora.",
    ...
    openGraph: {
      title:
        seo.metaTitle || "Goldfingers Aesthetics Mount Dora | Botox & Med Spa",
      description:
        seo.metaDescription ||
        "Visit Goldfingers Aesthetics in Mount Dora, FL for Botox, fillers, and professional med spa treatments.",
      url,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Goldfingers Aesthetics Mount Dora Location",
        },
      ],
    },
    ...
    keywords: [
      "Botox Mount Dora FL",
      "Dermal fillers Mount Dora",
      "Med spa Mount Dora",
      "Lip fillers Mount Dora",
      "Goldfingers Aesthetics Mount Dora",
      "Aesthetic clinic Mount Dora Florida",
      "Botox near me Mount Dora",
    ],
  };
}

// ==========================
// ✅ Structured Data (Strong Local Signal)
// ==========================
...
export default async function MountDoraPage() {
  ...
  return (
    <>
      <Script
        id="mount-dora-structured-data"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(structuredData),
        }}
      />
      <MountDoraContent data={data} />
    </>
  );
}
