...
// //       `${PAYLOAD_API_URL}/cheek-fillers-page-component?where[isActive][equals]=true&depth=2&limit=100&draft=false&trash=false`,
// //       {
// //         next: { revalidate: 60 },
// //         cache: "force-cache",
// //       }
...
// //     if (!res.ok) {
// //       throw new Error(
// //         `Failed to fetch Cheek Fillers page data: ${res.statusText}`
// //       );
// //     }
// //     const data = await res.json();
// //     const activeComponent =
// //       data.docs?.find((component: any) => component.isActive) || null;
// //     console.log("Fetched Cheek Fillers data:", activeComponent); // Debug log
// //     return activeComponent;
// //   } catch (error) {
// //     console.error("Error fetching Cheek Fillers page data:", error);
// //     return null;
// //   }
// // }
...
export async function fetchCheekFillersPageData() {
  try {
    ...
    const endpoint = `${PAYLOAD_API_URL}/cheek-fillers-page-component`;
